...
import CommentActionPopupMenu from "./CommentActionPopupMenu";
function Comment({ comment, mainUserId,comments,setComments,setCommentCount }) {
  ...
  return (
    <div style={{display:"flex"}}>
      ...
      <div className="div">
            {
              (owner?.id === mainUserId) &&
              <CommentActionPopupMenu comment={comment} 
