      ...
      const scroll = () => {
        if (state.prevScrollY !== undefined && state.prevScrollY !== 0) {
          ...
          if (browserback === false) {
            ...
            // burada scroll sorunu çözümü için çok az timeout koyuldu
            // çünkü scroll edilecek konum geldiği halde önce kartların render olmasını beklemiyordu
            setTimeout(()=> window.scrollTo(0, h),10)
